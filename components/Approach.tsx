...
export default function Approach() {
  return (
    <section className="w-full lg:pt-20 md:pt-16 sm:pt-16 pt-16">
      <h1 className="heading">
        My
        <span className="text-purple"> approach</span>
      </h1>
      <div className="lg:my-20 my-16 flex flex-col lg:flex-row items-center justify-cente w-full gap-4">
        <Card
          title="Planning"
